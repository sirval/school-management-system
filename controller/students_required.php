...
if (!isset($_SESSION['studentId']) && !isset($_SESSION['student']) && !isset($_SESSION['studSchool']) ) {
    header('location:index.php');
}

    $studSchool=$_SESSION['studSchool'];
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
         ...
         $studentId = $_SESSION['studentId'];
          $sql=mysqli_query($conn, "SELECT * FROM students WHERE id='$studentId'");
          while ($res=mysqli_fetch_array($sql)) {
            $passport=$res['studPics'];
          }
          ?>
          <p class="centered"><a href="#"><img src="<?php echo '../schools/student_passport/'.$passport; ?>" class="img-circle" width="80" height="80" alt="Passport" ></a></p>
          <h5 class="centered"><?php echo $_SESSION['student']; ?> &nbsp;<i class="label label-success">Online</i></h5>
          <li class="mt">
